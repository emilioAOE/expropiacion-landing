  ...
  return (
    <section className="relative pt-20 sm:pt-24 pb-16 sm:pb-24 bg-primary overflow-hidden">
      ...
      <div className="absolute right-0 top-1/2 -translate-y-1/2 opacity-[0.03] hidden lg:block">
        <svg width="600" height="600" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-white leading-tight mb-6">
              Protege Tu Propiedad Frente a la{" "}
            ...
            <p className="text-lg sm:text-xl text-blue-100/80 leading-relaxed mb-8 max-w-2xl">
              Tienes derecho a una justa indemnización. Nuestros abogados
              especialistas en Decreto Ley 2186 defienden tu patrimonio y
              aseguran que recibas lo que realmente corresponde.
            </p>

            <div className="flex flex-col sm:flex-row gap-4">
              <a
                href="#formulario"
                className="inline-flex items-center justify-center gap-3 bg-white hover:bg-gray-100 text-primary text-lg font-bold px-8 py-4 rounded-full transition-all hover:scale-105 shadow-lg shadow-white/15"
              >
          ...
          <div className="hidden lg:flex flex-col items-center justify-center gap-6">
            ...
            <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl px-6 py-4 flex items-center gap-4 w-full max-w-sm">
              <div className="flex -space-x-2">
                {["bg-accent", "bg-blue-400", "bg-green-400", "bg-purple-400"].map(
                  (color, i) => (
                    <div
                      key={i}
              ...
              <div className="text-sm text-blue-200/70">
                <span className="text-white font-semibold">+50 personas</span>{" "}
